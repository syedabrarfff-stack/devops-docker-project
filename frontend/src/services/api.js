...
export const launchCampaign = (leadIds, generateBrief = true) => api.post('/api/v1/outreach/launch-campaign', { lead_ids: leadIds, generate_brief: generateBrief }, { timeout: 60000 }).then(r => r.data)
