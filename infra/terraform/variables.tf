...
variable "nvidia_api_key_b" {
  type      = string
  sensitive = true
  default   = ""
}
variable "nvidia_api_key_c" {
  type      = string
  sensitive = true
  default   = ""
}
variable "nvidia_api_key_d" {
  type      = string
  sensitive = true
  default   = ""
}
variable "nvidia_api_key_e" {
  type      = string
  sensitive = true
  default   = ""
}
variable "nvidia_api_key_f" {
  type      = string
  sensitive = true
  default   = ""
}
variable "nvidia_api_key_g" {
  type      = string
  sensitive = true
  default   = ""
}
variable "nvidia_api_key_h" {
  type      = string
  sensitive = true
  default   = ""
}
variable "nvidia_api_key_i" {
  type      = string
  sensitive = true
  default   = ""
}
variable "nvidia_api_key_j" {
  type      = string
  sensitive = true
  default   = ""
}
