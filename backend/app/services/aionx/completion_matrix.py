...
SYSTEMS: list[dict[str, str]] = [
    ...
    {"system": "Omni 227-System Registry", "status": "LIVE_PERSISTENT", "evidence": "aionx_omni_system_registry + /aionx/omni"},
    {"system": "Mission Control Dashboard", "status": "LIVE", "evidence": "aionx_mission_control_events + /aionx/mission-control"},
    {"system": "System Health HUD", "status": "LIVE", "evidence": "aionx_system_hud_snapshots + /system/hud"},
    {"system": "Stability Runbooks", "status": "LIVE_PERSISTENT", "evidence": "aionx_stability_runbooks + /aionx/stability"},
    {"system": "Self-Healing Diagnostics", "status": "LIVE_GOVERNED", "evidence": "aionx_self_healing_records + non-destructive diagnosis endpoint"},
